...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $position = ""; // You can set the position value as needed
    $role = 0; // Normal user role

    if (registerUsers($username, $password, $position, $role)) {
        header("Location: index_page.php"); // Redirect to index page on successful registration
        exit();
    } else {
